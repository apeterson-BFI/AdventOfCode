...
namespace Adv2020
{
    class Program
    {
        ...
        {
            DayN98 dn98 = new DayN98();
            long answer = dn98.getPart1Answer();
            Console.WriteLine("2015 Day 2 P1: {0}", answer);
            answer = dn98.getPart2Answer();
            Console.WriteLine("2015 Day 2 P2: {0}", answer);
            Console.ReadLine();
        }
